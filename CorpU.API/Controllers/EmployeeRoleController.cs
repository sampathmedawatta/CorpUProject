...
namespace CorpU.API.Controllers
{
    ...
    public class EmployeeRoleController : ControllerBase
    {
        ...
        [HttpGet("All")]
        public async Task<ActionResult> GetAllEmplyeeRole()
        {
            try
            {
                IEnumerable<EmployeeRoleDto> employeeRoleList = await _employeeManager.GetAllAsync();
                ...
                if (employeeRoleList == null)
                {
                    _or = new OperationResult
                    {
                        Message = "Employee Role details not found!",
                        StatusCode = (int)HttpStatusCode.NotFound,
                        Data = null
                    };
                }
